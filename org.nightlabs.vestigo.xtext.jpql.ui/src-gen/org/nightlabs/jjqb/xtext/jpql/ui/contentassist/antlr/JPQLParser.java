...
* generated by Xtext
*/
package org.nightlabs.jjqb.xtext.jpql.ui.contentassist.antlr;
...
public class JPQLParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.nightlabs.jjqb.xtext.jpql.ui.contentassist.antlr.internal.InternalJPQLParser createParser() {
		org.nightlabs.jjqb.xtext.jpql.ui.contentassist.antlr.internal.InternalJPQLParser result = new org.nightlabs.jjqb.xtext.jpql.ui.contentassist.antlr.internal.InternalJPQLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComparisonOperatorExpressionAccess().getLeftAssignment_0(), "rule__ComparisonOperatorExpression__LeftAssignment_0");
					...
					put(grammarAccess.getComparisonOperatorExpressionAccess().getRightAssignment_2(), "rule__ComparisonOperatorExpression__RightAssignment_2");
					put(grammarAccess.getExistsExpressionAccess().getIsNotAssignment_0(), "rule__ExistsExpression__IsNotAssignment_0");
					put(grammarAccess.getExistsExpressionAccess().getRightAssignment_2(), "rule__ExistsExpression__RightAssignment_2");
