		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStringFunctionExpressionAccess().getAlternatives(), "rule__StringFunctionExpression__Alternatives");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getAlternatives(), "rule__ArithmeticFunctionExpression__Alternatives");
					put(grammarAccess.getCollectionFunctionExpressionAccess().getAlternatives(), "rule__CollectionFunctionExpression__Alternatives");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getAlternatives(), "rule__TemporalFunctionExpression__Alternatives");
					...
					put(grammarAccess.getTrimSpecAccess().getAlternatives(), "rule__TrimSpec__Alternatives");
					...
					put(grammarAccess.getParameterExpressionAccess().getGroup_1(), "rule__ParameterExpression__Group_1__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_0(), "rule__StringFunctionExpression__Group_0__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_0_3(), "rule__StringFunctionExpression__Group_0_3__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_1(), "rule__StringFunctionExpression__Group_1__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_1_5(), "rule__StringFunctionExpression__Group_1_5__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_2(), "rule__StringFunctionExpression__Group_2__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_3(), "rule__StringFunctionExpression__Group_3__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_4(), "rule__StringFunctionExpression__Group_4__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_5(), "rule__StringFunctionExpression__Group_5__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_6(), "rule__StringFunctionExpression__Group_6__0");
					put(grammarAccess.getStringFunctionExpressionAccess().getGroup_6_5(), "rule__StringFunctionExpression__Group_6_5__0");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getGroup_0(), "rule__ArithmeticFunctionExpression__Group_0__0");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getGroup_1(), "rule__ArithmeticFunctionExpression__Group_1__0");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getGroup_2(), "rule__ArithmeticFunctionExpression__Group_2__0");
					put(grammarAccess.getCollectionFunctionExpressionAccess().getGroup_0(), "rule__CollectionFunctionExpression__Group_0__0");
					put(grammarAccess.getCollectionFunctionExpressionAccess().getGroup_1(), "rule__CollectionFunctionExpression__Group_1__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_0(), "rule__TemporalFunctionExpression__Group_0__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_0_1(), "rule__TemporalFunctionExpression__Group_0_1__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_1(), "rule__TemporalFunctionExpression__Group_1__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_1_1(), "rule__TemporalFunctionExpression__Group_1_1__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_2(), "rule__TemporalFunctionExpression__Group_2__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_2_1(), "rule__TemporalFunctionExpression__Group_2_1__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_3(), "rule__TemporalFunctionExpression__Group_3__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_4(), "rule__TemporalFunctionExpression__Group_4__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_5(), "rule__TemporalFunctionExpression__Group_5__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_6(), "rule__TemporalFunctionExpression__Group_6__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_7(), "rule__TemporalFunctionExpression__Group_7__0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getGroup_8(), "rule__TemporalFunctionExpression__Group_8__0");
					...
					put(grammarAccess.getParameterExpressionAccess().getNameAssignment_0_1(), "rule__ParameterExpression__NameAssignment_0_1");
					put(grammarAccess.getParameterExpressionAccess().getIndexAssignment_1_1(), "rule__ParameterExpression__IndexAssignment_1_1");
					put(grammarAccess.getStringFunctionExpressionAccess().getNameAssignment_0_0(), "rule__StringFunctionExpression__NameAssignment_0_0");
					put(grammarAccess.getStringFunctionExpressionAccess().getFieldsAssignment_0_2(), "rule__StringFunctionExpression__FieldsAssignment_0_2");
					put(grammarAccess.getStringFunctionExpressionAccess().getFieldsAssignment_0_3_1(), "rule__StringFunctionExpression__FieldsAssignment_0_3_1");
					put(grammarAccess.getStringFunctionExpressionAccess().getNameAssignment_1_0(), "rule__StringFunctionExpression__NameAssignment_1_0");
					put(grammarAccess.getStringFunctionExpressionAccess().getFieldAssignment_1_2(), "rule__StringFunctionExpression__FieldAssignment_1_2");
					put(grammarAccess.getStringFunctionExpressionAccess().getStartPosAssignment_1_4(), "rule__StringFunctionExpression__StartPosAssignment_1_4");
					put(grammarAccess.getStringFunctionExpressionAccess().getLengthAssignment_1_5_1(), "rule__StringFunctionExpression__LengthAssignment_1_5_1");
					put(grammarAccess.getStringFunctionExpressionAccess().getNameAssignment_2_0(), "rule__StringFunctionExpression__NameAssignment_2_0");
					put(grammarAccess.getStringFunctionExpressionAccess().getTrimSpecAssignment_2_2(), "rule__StringFunctionExpression__TrimSpecAssignment_2_2");
					put(grammarAccess.getStringFunctionExpressionAccess().getTrimCharAssignment_2_3(), "rule__StringFunctionExpression__TrimCharAssignment_2_3");
					put(grammarAccess.getStringFunctionExpressionAccess().getFieldAssignment_2_5(), "rule__StringFunctionExpression__FieldAssignment_2_5");
					put(grammarAccess.getStringFunctionExpressionAccess().getNameAssignment_3_0(), "rule__StringFunctionExpression__NameAssignment_3_0");
					put(grammarAccess.getStringFunctionExpressionAccess().getFieldAssignment_3_2(), "rule__StringFunctionExpression__FieldAssignment_3_2");
					put(grammarAccess.getStringFunctionExpressionAccess().getNameAssignment_4_0(), "rule__StringFunctionExpression__NameAssignment_4_0");
					put(grammarAccess.getStringFunctionExpressionAccess().getFieldAssignment_4_2(), "rule__StringFunctionExpression__FieldAssignment_4_2");
					put(grammarAccess.getStringFunctionExpressionAccess().getNameAssignment_5_0(), "rule__StringFunctionExpression__NameAssignment_5_0");
					put(grammarAccess.getStringFunctionExpressionAccess().getFieldAssignment_5_2(), "rule__StringFunctionExpression__FieldAssignment_5_2");
					put(grammarAccess.getStringFunctionExpressionAccess().getNameAssignment_6_0(), "rule__StringFunctionExpression__NameAssignment_6_0");
					put(grammarAccess.getStringFunctionExpressionAccess().getFieldsAssignment_6_2(), "rule__StringFunctionExpression__FieldsAssignment_6_2");
					put(grammarAccess.getStringFunctionExpressionAccess().getFieldsAssignment_6_4(), "rule__StringFunctionExpression__FieldsAssignment_6_4");
					put(grammarAccess.getStringFunctionExpressionAccess().getStartPosAssignment_6_5_1(), "rule__StringFunctionExpression__StartPosAssignment_6_5_1");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getNameAssignment_0_0(), "rule__ArithmeticFunctionExpression__NameAssignment_0_0");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getFieldAssignment_0_2(), "rule__ArithmeticFunctionExpression__FieldAssignment_0_2");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getNameAssignment_1_0(), "rule__ArithmeticFunctionExpression__NameAssignment_1_0");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getFieldAssignment_1_2(), "rule__ArithmeticFunctionExpression__FieldAssignment_1_2");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getNameAssignment_2_0(), "rule__ArithmeticFunctionExpression__NameAssignment_2_0");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getFieldsAssignment_2_2(), "rule__ArithmeticFunctionExpression__FieldsAssignment_2_2");
					put(grammarAccess.getArithmeticFunctionExpressionAccess().getFieldsAssignment_2_4(), "rule__ArithmeticFunctionExpression__FieldsAssignment_2_4");
					put(grammarAccess.getCollectionFunctionExpressionAccess().getNameAssignment_0_0(), "rule__CollectionFunctionExpression__NameAssignment_0_0");
					put(grammarAccess.getCollectionFunctionExpressionAccess().getFieldAssignment_0_2(), "rule__CollectionFunctionExpression__FieldAssignment_0_2");
					put(grammarAccess.getCollectionFunctionExpressionAccess().getNameAssignment_1_0(), "rule__CollectionFunctionExpression__NameAssignment_1_0");
					put(grammarAccess.getCollectionFunctionExpressionAccess().getFieldAssignment_1_2(), "rule__CollectionFunctionExpression__FieldAssignment_1_2");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getNameAssignment_0_0(), "rule__TemporalFunctionExpression__NameAssignment_0_0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getNameAssignment_1_0(), "rule__TemporalFunctionExpression__NameAssignment_1_0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getNameAssignment_2_0(), "rule__TemporalFunctionExpression__NameAssignment_2_0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getNameAssignment_3_0(), "rule__TemporalFunctionExpression__NameAssignment_3_0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getFieldAssignment_3_2(), "rule__TemporalFunctionExpression__FieldAssignment_3_2");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getNameAssignment_4_0(), "rule__TemporalFunctionExpression__NameAssignment_4_0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getFieldAssignment_4_2(), "rule__TemporalFunctionExpression__FieldAssignment_4_2");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getNameAssignment_5_0(), "rule__TemporalFunctionExpression__NameAssignment_5_0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getFieldAssignment_5_2(), "rule__TemporalFunctionExpression__FieldAssignment_5_2");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getNameAssignment_6_0(), "rule__TemporalFunctionExpression__NameAssignment_6_0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getFieldAssignment_6_2(), "rule__TemporalFunctionExpression__FieldAssignment_6_2");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getNameAssignment_7_0(), "rule__TemporalFunctionExpression__NameAssignment_7_0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getFieldAssignment_7_2(), "rule__TemporalFunctionExpression__FieldAssignment_7_2");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getNameAssignment_8_0(), "rule__TemporalFunctionExpression__NameAssignment_8_0");
					put(grammarAccess.getTemporalFunctionExpressionAccess().getFieldAssignment_8_2(), "rule__TemporalFunctionExpression__FieldAssignment_8_2");
					...
					put(grammarAccess.getFloatAccess().getIntegerValueAssignment_0(), "rule__Float__IntegerValueAssignment_0");
					put(grammarAccess.getFloatAccess().getFractionValueAssignment_2(), "rule__Float__FractionValueAssignment_2");
