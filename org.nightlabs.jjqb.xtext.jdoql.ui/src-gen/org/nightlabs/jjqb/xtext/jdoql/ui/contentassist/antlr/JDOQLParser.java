		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStaticMethodExpressionAccess().getNumericAssignment_0_3(), "rule__StaticMethodExpression__NumericAssignment_0_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getNumericAssignment_1_3(), "rule__StaticMethodExpression__NumericAssignment_1_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getNumericAssignment_2_3(), "rule__StaticMethodExpression__NumericAssignment_2_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getNumericAssignment_3_3(), "rule__StaticMethodExpression__NumericAssignment_3_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getPersistableAssignment_4_3(), "rule__StaticMethodExpression__PersistableAssignment_4_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getPersistableAssignment_5_3(), "rule__StaticMethodExpression__PersistableAssignment_5_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getIsDistinctAssignment_6_3(), "rule__StaticMethodExpression__IsDistinctAssignment_6_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getAggregateArgumentAssignment_6_4(), "rule__StaticMethodExpression__AggregateArgumentAssignment_6_4");
					put(grammarAccess.getStaticMethodExpressionAccess().getIsDistinctAssignment_7_3(), "rule__StaticMethodExpression__IsDistinctAssignment_7_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getAggregateArgumentAssignment_7_4(), "rule__StaticMethodExpression__AggregateArgumentAssignment_7_4");
					put(grammarAccess.getStaticMethodExpressionAccess().getAggregateArgumentAssignment_8_3(), "rule__StaticMethodExpression__AggregateArgumentAssignment_8_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getAggregateArgumentAssignment_9_3(), "rule__StaticMethodExpression__AggregateArgumentAssignment_9_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getIsDistinctAssignment_10_3(), "rule__StaticMethodExpression__IsDistinctAssignment_10_3");
					put(grammarAccess.getStaticMethodExpressionAccess().getAggregateArgumentAssignment_10_4(), "rule__StaticMethodExpression__AggregateArgumentAssignment_10_4");
