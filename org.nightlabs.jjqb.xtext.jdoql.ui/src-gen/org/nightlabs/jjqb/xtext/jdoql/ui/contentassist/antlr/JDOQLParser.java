		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFieldAccessExpressionAccess().getGroup(), "rule__FieldAccessExpression__Group__0");
					...
					put(grammarAccess.getDeclaredParameterNameAccess().getNameAssignment(), "rule__DeclaredParameterName__NameAssignment");
					...
					put(grammarAccess.getFieldAccessExpressionAccess().getRightAssignment_1_2(), "rule__FieldAccessExpression__RightAssignment_1_2");
