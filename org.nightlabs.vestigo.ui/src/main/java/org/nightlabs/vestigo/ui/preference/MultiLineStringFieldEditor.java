...
/**
 * Copied from {@link StringFieldEditor}, because it is not well extendable. The
 * {@link Text} instance it uses cannot be replaced or initially created with {@link SWT#MULTI} :-(
 *
...
public class MultiLineStringFieldEditor extends FieldEditor {
	 ...
	 * @since 2.0
	 */
	public MultiLineStringFieldEditor(String name, String labelText, int width, int height,
	...
	public MultiLineStringFieldEditor(String name, String labelText, Composite parent) {
		this(name, labelText, UNLIMITED, 10, parent);
	}
