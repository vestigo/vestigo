 ...
 * <ul>
 *   <li>{@link org.nightlabs.vestigo.xtext.jpql.jPQL.WhereClause#getWhereEntry <em>Where Entry</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.nightlabs.vestigo.xtext.jpql.jPQL.JPQLPackage#getWhereClause()
 * @model
 * @generated
 */
public interface WhereClause extends EObject
{
   ...
   * @see org.nightlabs.vestigo.xtext.jpql.jPQL.JPQLPackage#getWhereClause_WhereEntry()
  ...
  /**
   * Sets the value of the '{@link org.nightlabs.vestigo.xtext.jpql.jPQL.WhereClause#getWhereEntry <em>Where Entry</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
