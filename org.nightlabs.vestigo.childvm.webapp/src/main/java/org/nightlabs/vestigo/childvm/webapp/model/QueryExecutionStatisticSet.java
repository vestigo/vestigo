 ...
 */
public class QueryExecutionStatisticSet {
	...
	public void registerQueryParameterEvaluationDuration(long duration) {
		setQueryParameterEvaluationDurationMax(Math.max(getQueryParameterEvaluationDurationMax(), duration));
		setQueryParameterEvaluationDurationMin(Math.min(getQueryParameterEvaluationDurationMin(), duration));
		setQueryParameterEvaluationDurationTotal(getQueryParameterEvaluationDurationTotal() + duration);
	}
