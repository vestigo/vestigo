 ...
 * <ul>
 *   <li>{@link org.nightlabs.vestigo.xtext.jdoql.jDOQL.impl.HavingClauseImpl#getHaving <em>Having</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HavingClauseImpl extends MinimalEObjectImpl.Container implements HavingClause
{
  ...
  {
    return JDOQLPackage.Literals.HAVING_CLAUSE;
  }
  ...
  public NotificationChain basicSetHaving(Expression newHaving, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JDOQLPackage.HAVING_CLAUSE__HAVING, oldHaving, newHaving);
  ...
  public void setHaving(Expression newHaving)
  {
    if (newHaving != having)
    {
      ...
      if (having != null)
        msgs = ((InternalEObject)having).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JDOQLPackage.HAVING_CLAUSE__HAVING, null, msgs);
      if (newHaving != null)
        msgs = ((InternalEObject)newHaving).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JDOQLPackage.HAVING_CLAUSE__HAVING, null, msgs);
      msgs = basicSetHaving(newHaving, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JDOQLPackage.HAVING_CLAUSE__HAVING, newHaving, newHaving));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JDOQLPackage.HAVING_CLAUSE__HAVING:
