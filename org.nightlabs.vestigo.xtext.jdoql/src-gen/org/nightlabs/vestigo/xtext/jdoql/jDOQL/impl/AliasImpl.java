...
public class AliasImpl extends MinimalEObjectImpl.Container implements Alias
{
  ...
  {
    return JDOQLPackage.Literals.ALIAS;
  }
  ...
  public void setIdentifier(String newIdentifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JDOQLPackage.ALIAS__IDENTIFIER, oldIdentifier, identifier));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JDOQLPackage.ALIAS__IDENTIFIER:
