...
public class CollectionResultSet implements IResultSet
{
	...
	public CollectionResultSet(ResultSetMetaData resultSetMetaData, Collection<?> elements)
	{
	...
	private void assertNotClosed() {
		if (resultSetMetaData == null)
			throw new IllegalStateException("This CollectionResultSet is already closed!");
	}
